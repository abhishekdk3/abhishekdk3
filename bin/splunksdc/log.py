...
__all__ = [
    ...
    "RotatingFileHandler",
    "get_context_logger",
    "ThreadLocalLoggingStack",
    "LogContext",
]

try:
    encode_basestring = encode.encode_basestring  # type: ignore
except:
    encode_basestring = encode.py_encode_basestring
...
class ThreadLocalLoggingStack(object):
    ...
    def empty(cls):
        return not (
            hasattr(cls._data, "logging_context_stack")
            and cls._data.logging_context_stack
        )
...
def setup_root_logger(
    app_name=None, modular_name=None, stanza_name=None, logging_level=WARNING
):
    """
